...
uint8_t static_perm[] = { 151,160,137,91,90,15,
...
void ImprovedPerlin::setSeed_unsafe(const uint32_t seed_in){
	randomSeed(seed_in);
	char buffer_char;
	uint16_t new_position;
	for (uint16_t i = 0; i < 512; i++){  // Go through entire array and swap every character for another randomly
